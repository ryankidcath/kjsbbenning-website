...
export const metadata: Metadata = {
  title: "Konsultasi Pertanahan Cirebon | KJSB Benning dan Rekan",
  description:
    "Konsultasi pertanahan gratis di Cirebon. Tanya soal sertifikasi tanah, pecah sertifikat, batas tanah, PBT, dan proses pertanahan lainnya bersama surveyor berlisensi ATR/BPN.",
};

const topik = [
  {
    title: "Sertifikasi Tanah",
    desc: "Konsultasi mengenai proses pendaftaran tanah pertama kali, syarat dokumen, prosedur pengukuran, dan alur penerbitan sertifikat di BPN.",
    icon: (
  ...
  },
  {
    ...
    desc: "Konsultasi proses pecah sertifikat, mulai dari syarat teknis pengukuran, pembuatan PBT untuk masing-masing bidang, hingga penerbitan sertifikat baru.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
  ...
  {
    title: "Batas Tanah & Patok",
    desc: "Konsultasi cara menentukan batas tanah yang sah sesuai sertifikat, proses pemasangan patok batas, dan penyelesaian ketidakjelasan batas antar bidang.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Konsultasi mengenai apa itu PBT, kapan PBT dibutuhkan, bagaimana proses pembuatannya, dan bagaimana menggunakannya dalam proses administrasi pertanahan.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Konsultasi proses verifikasi luas prasarana, sarana, dan utilitas umum perumahan sebelum diserahkan ke pemerintah daerah melalui DPKPP.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
  ...
  {
    title: "Proses Pertanahan Lainnya",
    desc: "Pertanyaan seputar pengukuran ulang, konsolidasi tanah, pendaftaran tanah sporadik, atau permasalahan pertanahan lain yang memerlukan klarifikasi teknis.",
    icon: (
      <svg className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
...
const alasan = [
  "Konsultasi langsung dengan surveyor berlisensi ATR/BPN",
  "Penjelasan teknis yang mudah dipahami",
  "Informasi akurat sesuai regulasi pertanahan terkini",
  "Tanpa biaya, tanpa kewajiban menggunakan jasa kami",
...
export default function KonsultasiPertanahan() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0f2744] via-[#1e3a5f] to-[#1e4976] px-6 pb-20 pt-14 text-white">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <nav className="mb-6 flex items-center gap-2 text-sm text-blue-300">
            ...
            <span>/</span>
            <span className="text-white">Konsultasi Pertanahan</span>
          </nav>
          ...
          <span className="inline-block rounded-full border border-blue-400/40 bg-blue-400/10 px-4 py-1 text-sm font-medium text-blue-300">
            Konsultasi Gratis · Surveyor Berlisensi ATR/BPN
          </span>

          <h1 className="mt-4 text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl lg:text-5xl">
            Konsultasi Pertanahan di Cirebon
          </h1>

          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-blue-100">
            Punya pertanyaan seputar sertifikasi tanah, pecah sertifikat, batas
            tanah, atau proses pertanahan lainnya? Konsultasikan langsung
            dengan tim surveyor berlisensi KJSB Benning dan Rekan —{" "}
            <strong className="text-white">gratis, tanpa syarat</strong>.
          </p>
      ...
      {/* ── 2. TOPIK KONSULTASI ── */}
      <section id="topik" className="bg-white px-6 py-16">
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-slate-500">
              Tim kami siap menjawab pertanyaan seputar berbagai proses
              pertanahan yang sering membingungkan masyarakat.
            </p>
          </div>
      ...
      <section className="bg-slate-50 px-6 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="border-l-4 border-[#25D366] p-6 sm:p-8">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#0f172a]">
                    Konsultasi Gratis, Langsung dengan Ahlinya
                  </h3>
                  <p className="mt-2 leading-relaxed text-slate-600">
                    Anda berbicara langsung dengan surveyor berlisensi yang
                    berpengalaman di bidang pertanahan Cirebon, bukan petugas
                    administrasi. Tidak ada biaya konsultasi dan tidak ada
                    kewajiban menggunakan jasa kami setelah konsultasi.
                  </p>
        ...
        <div className="mx-auto max-w-3xl">
          <div className="rounded-2xl bg-gradient-to-br from-[#0f2744] via-[#1e3a5f] to-[#1e4976] px-8 py-12 text-center text-white">
            ...
            <p className="mx-auto mt-4 max-w-lg leading-relaxed text-blue-100">
              Kirim pesan melalui WhatsApp dan ceritakan permasalahan
              pertanahan Anda. Tim kami akan merespons dengan cepat dan
            ...
            <p className="mt-4 text-sm text-blue-200">
              Konsultasi gratis · Tanpa kewajiban · Melayani Kota &amp;
              Kabupaten Cirebon
            </p>
          </div>
        </div>
